    ...
    <div class="row" id='configs'>
        ...
        <form method='POST' id='moloniOptions' action='{$moloni.configurations.formSave|escape:'html':'UTF-8'}'>
            ...
            <div class="col s12 z-depth-1">
                ...
                <div class='input-field col s6' style='margin-top: 50px'>
                    <label for='after_date' class='label-input'
                           style='cursor: pointer; left: 20px; top: 15px'>{l s='Show orders since' mod='moloni'}</label>
                    <input type="date" class="datepicker" name='options[after_date]' id='after_date'
            ...
            <div class="col s12 z-depth-1">
                ...
                <div class='input-field'>
                    <div class="col s3" style="display: flex; flex-direction: column; padding-bottom: 20px">
                        ...
                        <label style="font-size: 0.8rem; color: black; font-weight:normal;" for="name">
                            {l s='Name' mod='moloni'}
                        </label>

                        <input type="checkbox" id="price" name='sync_fields[]' value="price">
                        <label style="font-size: 0.8rem; color: black; font-weight:normal;" for="price">
                            {l s='Price' mod='moloni'}
                        </label>

                        <input type="checkbox" id="description" name='sync_fields[]'
                               value="description">
                        <label style="font-size: 0.8rem; color: black; font-weight:normal;" for="description">
                            {l s='Description' mod='moloni'}
                        </label>

                        <input type="checkbox" id="ean" name='sync_fields[]'
                               value="ean">
                        <label style="font-size: 0.8rem; color: black; font-weight:normal;" for="ean">
                            {l s='EAN' mod='moloni'}
                        </label>

                        <input type="checkbox" id="stock" name='sync_fields[]'
                               value="stock">
                        <label style="font-size: 0.8rem; color: black; font-weight:normal;" for="stock">
                            {l s='Stock' mod='moloni'}
                        </label>
                    </div>

                    <div class="col s3">
                        <a class="waves-effect waves-light blue btn-large" style="color: white"
                           id="formToolsSubmit"
