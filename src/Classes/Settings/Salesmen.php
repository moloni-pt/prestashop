...
class Salesmen extends Settings
{
    ...
    public function getAll($companyID = COMPANY)
    {
        ...
        $result = Curl::simple("salesmen/getAll", $values);
        return ($result);
    }
    ...
    {
        $values = ["company_id" => $companyID];
        $result = Curl::simple("salesmen/insert", $values);
        return ($result);
    }
    ...
    {
        $values = ["company_id" => $companyID];
        $result = Curl::simple("salesmen/update", $values);
        return ($result);
    }
    ...
    {
        $values = ["company_id" => $companyID];
        $result = Curl::simple("salesmen/delete", $values);
        return ($result);
    }
}
